...
using MortalKombatFatalities.Services;

namespace MortalKombatFatalities
{
    static class Bootstrap
    {
        private static readonly Guid APP_ID = new Guid("ea9bfd29-33c2-4652-9bb2-182218a8adaa");
